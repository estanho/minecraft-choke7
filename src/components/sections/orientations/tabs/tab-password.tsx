...
export function TabPassword() {
  return (
    <>
      <div>
        <h3>Senha do Minecraft (IMPORTANTE)</h3>
        <p>
          ...
          <AccordionItem value="password">
            ...
            <AccordionContent>
              <p className="text-base">
                Você não vai precisar digitar essa senha em nenhum momento, ela
                é utilizada pelo mod automaticamente quando você entra no
                servidor.
              </p>
              <ModalImg
                src={images.password}
        ...
        <p className="font-medium">
          ⚠️ IMPORTANTE: ⚠️ <br /> Essa senha fica salva na sua pasta do
          minecraft em um arquivo chamado &quot;.sl_password&quot;. <br /> Caso
          precise reinstalar o minecraft, SALVE ESSE ARQUIVO!
        </p>
      </div>
      ...
      <p className="orientation-step mt-12 font-bold">
        Agora você já pode ir para o último passo:
      </p>
    </>
  );
}
