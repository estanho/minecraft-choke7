  ...
  return (
    <>
      <div>
        <h3>Whitelist</h3>
        <p>
          O servidor possui whitelist e o acesso é liberado apenas para os SUBS
          da Choke7.
        </p>
        ...
        <p>
          ...
          Você deve enviar o seu username da Twitch e do Minecraft.
        </p>

        <p className="mb-3">Utilize esse formato de exemplo:</p>
        <div
        ...
        <p className="mb-6 font-medium">
          ⏳ Após enviar a mensagem, aguarde um dos admin do servidor entrar em
          contato via privado do Discord com as orientações finais de conexão
          (Endereço de conexão e etc).
        </p>
      </div>
      ...
      <p className="text-foreground/60 text-center text-lg">
        ...
        trapaças. Qualquer problema converse com os administradores. <br />{" "}
        Apenas aproveite e faça amigos! 🐸❤️
      </p>
    </>
  );
}
